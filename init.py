...
Tile("Eau+Sable (NW)",fileName="eaunw.png",doPass=True,speed=0.05)
Tile("Eau+Sable (NE)",fileName="eaune.png",doPass=True,speed=0.05)
Tile("Eau+Sable (SW)",fileName="eausw.png",doPass=True,speed=0.05)
Tile("Eau+Sable (SE)",fileName="eause.png",doPass=True,speed=0.05)